...
<div class="panel">
    ...
    <p>Important definitions, laws, equations and magnetic-material relations.</p>
</div>
""", unsafe_allow_html=True)
...
MAGNETISM_FORMULA_TABLE = [
    ...
    ("Magnetic moment of current loop",
     r"m",
     r"\mathbf{m} = I\mathbf{A}",
     r"I = current, A = area vector"),
    ...
    ("Lenz's law",
     r"\varepsilon",
     r"\text{Induced current opposes the change in magnetic flux}",
    ...
    ("General motional emf",
     r"\varepsilon",
     r"\varepsilon =
     \int(\mathbf{v}\times\mathbf{B})\cdot d\boldsymbol{\ell}",
     "General form"),
...
<div style="
    display:grid;
    grid-template-columns:1.55fr 0.55fr 2.7fr 1.35fr;
    gap:10px;
    padding:12px 10px;
