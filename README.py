...
/* columns ke beech unnecessary gap kam */
.converter-row [data-testid="column"] {
    padding-left:4px;
    padding-right:4px;
}

/* value + unit controls ko same height */
.converter-row div[data-baseweb="input"] > div,
.converter-row div[data-baseweb="select"] > div {
    min-height:44px;
}
...
UNITS = {
    ...
    # ========================================================
    # MAGNETIC QUANTITIES — ASSIGNMENT ORDER
    # ========================================================
    ...
    "Mass susceptibility (χ = κ/ρ)": {
        "m³/kg": 1,
        "emu Oe⁻¹ g⁻¹": 1000/(4*math.pi)
    },

    "Molar magnetic susceptibility (χₘ = χM*)": {
        "m³/mol": 1,
        "emu Oe⁻¹ g⁻¹ mol⁻¹": 1e6/(4*math.pi)
    },
...
def safe_eval(expr):
    ...
    def walk(node):
        ...
        if (
            ...
            if len(node.args) != 1:
                raise ValueError(
                    "Use one argument in a function."
                )
...
with converter:
    ...
    <div class="panel">
        ...
        <p>
            Convert common physical quantities between
            SI/MKS, CGS and practical units.
        </p>
    ...
    # ========================================================
    # ENTER VALUE + FROM UNIT — SAME BOX
    # ========================================================

    st.markdown(
        '<div class="converter-row">'
        '<div class="converter-row-title">'
        '🔢 ENTER VALUE &nbsp;&nbsp;&nbsp; 📤 FROM UNIT'
        '</div>',
        unsafe_allow_html=True
    )
...
with constants:
    ...
    <div class="panel">
        ...
        <p>
            Frequently used constants for Physics calculations.
        </p>
